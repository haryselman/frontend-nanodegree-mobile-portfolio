...
var pizzaElementGenerator = function(i) {
    ...
    pizzaImage.src = "images/pizza-200_small_2x.png";
...
// Used requestAnimationFrame in scrolling as described on http://www.html5rocks.com/en/tutorials/speed/animations/
...
// On the scroll event the onScroll function is triggered, which triggers in turn requestTick function which triggers requestAnimationFrame(updatePositions)
...
function updatePositions() {
    ...
    // Resets the ticking variable at the end of running the functions
    window.ticking = false;
}
...
document.addEventListener('DOMContentLoaded', window.requestAnimationFrame(function() {
    ...
    for (var i = 0; i < 30; i++) {
        ...
        selectedPizzas.appendChild(elem);
    }
